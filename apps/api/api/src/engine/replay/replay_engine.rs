    ...
    async fn fork_run(
        ...
        for span in spans {
            let cloned_span = Span {
                ...
                max_attempts: span.max_attempts,
                tool_name: span.tool_name,
                tool_version: span.tool_version,
                tool_latency_ms: span.tool_latency_ms,
